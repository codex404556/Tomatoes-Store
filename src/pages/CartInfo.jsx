...
const CartInfo = () => {
  ...
  return products.length > 0 && cartItems ? (
    <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mt-30 mx-auto">
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-medium mb-6">
          Shopping Cart{" "}
          <span className="text-sm border rounded-full bg-primary text-white px-2 py-1">{getCartCount()} items</span>
        </h1>
